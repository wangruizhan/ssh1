    ...
    <div id="base" class="">
      ...
      <div id="u139" class="ax_h1">
        ...
        <div id="u140" class="text">
          <p><span>主数据</span><span>管理</span><span>&gt;</span><span>折扣管理&gt;</span><span>经常性</span><span>折扣</span></p>
        </div>
      </div>
      ...
      <div id="u157" class="ax_menu">
        <img id="u157_menu" class="img " src="images/折扣新增/u157_menu.png" alt="u157_menu"/>
      ...
      <div id="u173" class="ax_vertical_line">
        ...
        <img id="u173_line" class="img " src="images/登录/u105_line.png" alt="u173_line"/>
      </div>
      ...
      <div id="u175" class="ax_paragraph">
        ...
        <div id="u176" class="text">
          <p><span>★</span><span>备注：</span></p><p><span>1.折扣名称：输入文本，任意</span></p><p><span>2.折扣类型：LOV选择，一般折扣、通用加价</span><span>；选择加价时，默认折扣基准为“数量”；选择一般折扣时，折扣基准默认为“金额”</span></p><p><span>3.折扣基准：LOV选择，金额、单价、数量</span></p><p><span>4.</span><span>基准数量（片）：输入整数数字；当折扣基准为“数量”时可以输入，“金额”或“单价”基准时不能输入。</span></p><p><span>5.折扣率：输入数字，百分比用小数表示，正数为加价，负数为折扣。</span></p><p><span>6.有效：默认为“是”</span></p>
        </div>
      </div>
      ...
      <div id="u179" class="ax_horizontal_line">
        <img id="u179_start" class="img " src="resources/images/transparent.gif" alt="u179_start"/>
        <img id="u179_end" class="img " src="resources/images/transparent.gif" alt="u179_end"/>
        <img id="u179_line" class="img " src="images/订单导入/u136_line.png" alt="u179_line"/>
      </div>
    </div>
  </body>
</html>
